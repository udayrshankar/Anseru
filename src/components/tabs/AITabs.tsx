  ...
  return (
    ...
    >
      <div className="mb-15 text-center max-w-2xl mx-auto">
              <p className="text-sm text-[#1C32E6]/70 mb-3 uppercase tracking-widest font-medium">
                Proven Results
              </p>
              <h2 className="text-[#1C32E6] text-3xl md:text-5xl font-medium tracking-tight mb-4">
                Two Agents. One Mission
              </h2>
              <p className="text-lg text-[#1C32E6]/70">
      ...
      <div className="max-w-[1400px] mx-auto relative">
       ...
       {/* Card Container - Enhanced Glassmorphism & Depth */}
        <div className="relative rounded-[30px] md:rounded-[40px] shadow-[0_40px_100px_rgba(0,0,0,0.12),0_10px_40px_rgba(0,0,0,0.04)] p-6 md:p-10 min-h-auto md:min-h-[650px] border border-black/10 bg-white/40 backdrop-blur-xl">
          ...
          <div className="absolute top-0 right-0 w-[300px] md:w-[600px] h-[300px] md:h-[600px] bg-[#7D23F7]/20 rounded-full blur-[80px] md:blur-[120px] pointer-events-none -z-10 animate-pulse-slow" />
          <div className="absolute bottom-0 left-0 w-[250px] md:w-[500px] h-[250px] md:h-[500px] bg-[#1C32E6]/20 rounded-full blur-[60px] md:blur-[100px] pointer-events-none -z-10" />
              ...
              <div className="bg-white backdrop-blur-2xl shadow-[0_8px_40px_rgba(0,0,0,0.08)] border border-black/80 rounded-full py-1.5 md:py-2 flex gap-1 items-center max-w-full overflow-x-auto no-scrollbar ring-1 ring-black/[0.03]">
                  ...
                  >
                      ...
                      <motion.div
                          ...
                          className="absolute inset-0 bg-gradient-to-r from-[#1C32E6] to-[#7D23F7] rounded-full mx-1 md:mx-2" 
                      />
                      )}
             ...
             >
               ...
               <div className="lg:col-span-6 space-y-3">
                  <div className="space-y-1">
                     <div className="inline-flex items-center gap-2 py-1 rounded-full bg-[#FF3F49]/10 border border-[#FF3F49]/30 w-fit">
                        <span className="relative flex h-2 w-2">
                          <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#FF3F49] opacity-75"></span>
                          <span className="relative inline-flex rounded-full h-2 w-2 bg-[#FF3F49]"></span>
                        </span>
                        <p className="text-[#FF3F49] uppercase tracking-widest text-xs md:text-[15px] font-bold">
                           {tabContent[activeTab].subtitle}
                        </p>
                     </div>
                     
                     <h2 className="text-2xl md:text-3xl lg:text-[38px] font-bold text-[#1C32E6] leading-[1.1] tracking-tight">
                  ...
                  <div>
                      {tabContent[activeTab].bullets.map((b, i) => (
                         <div key={i} className="flex items-start gap-4 p-3 rounded-xl hover:bg-white/60 transition-colors duration-300 border border-transparent hover:border-purple-100/50 group/item">
                            <div className="mt-1 w-6 h-6 rounded-full bg-gradient-to-br from-[#1C32E6] to-[#7D23F7] flex items-center justify-center shrink-0 shadow-md group-hover/item:scale-110 transition-transform">
                               <Check className="w-3.5 h-3.5 text-white stroke-[3px]" />
                            </div>
                            <div className="space-y-1">
                                <p className="text-sm md:text-[15px] font-medium text-[#1C32E6] leading-tight">
                                    {b.title}
                                </p>
                                <p className="text-xs md:text-sm text-[#1C32E6]/70 leading-relaxed">
                                    {b.description}
                                </p>
                                <div className="inline-flex items-center gap-1.5 px-2 py-1 bg-[#1C32E6]/10 text-[#1C32E6] text-[10px] md:text-xs font-semibold rounded-md mt-1 border border-[#1C32E6]/20">
                  ...
                  <button className="relative mx-0 md:mx-12 overflow-hidden bg-gradient-to-r from-[#1C32E6] to-[#7D23F7] text-white px-9 h-[52px] rounded-2xl font-bold text-sm md:text-[15px] transition-all shadow-[0_10px_30px_rgba(28,50,230,0.25)] hover:shadow-[0_20px_40px_rgba(125,35,247,0.35)] hover:-translate-y-1 flex items-center justify-center gap-3 w-full md:w-fit group">
               ...
               <div className="lg:col-span-6 relative mt-5 aspect-[13/10] border-5 border-white rounded-[24px] overflow-hidden ">
                  <div className="scale-90 md:scale-115 -translate-y-6 md:-translate-y-12">
                    <AnimationCarousel />
                  </div>
               </div>
