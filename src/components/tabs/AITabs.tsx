          ...
          {/* Content Area */}
           <AnimatePresence mode="wait">
             <motion.div
               ...
               className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-center h-full"
             >
               {/* Left Side: Content */}
               <div className="lg:col-span-4 space-y-10">
                  <div className="space-y-5">
                     ...
                     <h2 className="text-3xl md:text-[42px] font-bold text-[#2A1638] leading-[1.1] tracking-tight">
                  ...
                  <div className="space-y-5">
                      {tabContent[activeTab].bullets.map((b, i) => (
                         <div key={i} className="flex items-start gap-4 p-3 rounded-xl hover:bg-white/60 transition-colors duration-300 border border-transparent hover:border-purple-100/50">
                            ...
                            <span className="text-[16px] font-medium text-[#483953] leading-relaxed">{b}</span>
                         </div>
                      ))}
                  </div>

                  {/* CTA Button - Shimmer Effect */}
                  <button className="relative overflow-hidden bg-[#2A1638] hover:bg-[#3d2151] text-white px-9 h-[56px] rounded-2xl font-bold text-[15px] transition-all shadow-[0_10px_30px_rgba(42,22,56,0.2)] hover:shadow-[0_20px_40px_rgba(42,22,56,0.3)] hover:-translate-y-1 flex items-center gap-3 w-fit group">
